...
Entity.prototype.save$ = function(props,cb) {
  ...
  if ( _.isFunction(cb) ) {
      ...
      return si.actAsync( self.private$.entargs({cmd:'save'}) )
  }
}
...
Entity.prototype.native$ = function(cb) {
  ...
  if ( _.isFunction(cb) ) {
      si.act( self.private$.entargs({cmd:'native'}),cb)
      return self
  } else {
      return si.actAsync( self.private$.entargs({cmd:'native'}) )
  }
}
...
Entity.prototype.load$ = function(qin,cb) {
  ...
  if ( _.isFunction(cb) ) {
      ...
      return si.actAsync( self.private$.entargs({ qent:qent, q:q, cmd:'load' }) );
  }
}
...
Entity.prototype.list$ = function(qin,cb) {
  ...
  if ( _.isFunction(cb) ) {
      si.act( self.private$.entargs({qent:qent,q:q,cmd:'list'}), cb )
      return self
  } else { //promise
    return si.actAsync(self.private$.entargs({qent:qent,q:q,cmd:'list'}) )
  }
}
...
Entity.prototype.remove$ = function(qin,cb) {
  ...
  if ( _.isFunction(cb) ) {
      si.act( self.private$.entargs({qent:self,q:q,cmd:'remove'}), cb )
      return self
  } else {
      return si.actAsync( self.private$.entargs({qent:self,q:q,cmd:'remove'}) )
  }
}
...
Entity.prototype.close$ = function(cb) {
  ...
  if ( _.isFunction(cb) ) {
        si.act( self.private$.entargs({cmd:'close'}), cb) 
        return self
  } else {
      return si.actAsync( self.private$.entargs({cmd:'close'}) )
  }
}
